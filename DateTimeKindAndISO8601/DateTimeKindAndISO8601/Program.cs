...
namespace DateTimeoperations
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //ISO 8601
            //Formmat: yyyy-MM-ddTHH:mm:ssZ (Z indicates that the date/time is in UTC.)

            DateTime d4 = DateTime.Parse("2000-08-15 13:05:58");
            DateTime d5 = DateTime.Parse("2000-08-15T13:05:58Z"); // creates a local DateTime
            ...
            Console.WriteLine();
            Console.WriteLine(d5.ToString("yyyy-MM-ddTHH:mm:ssZ")); // Careful!
